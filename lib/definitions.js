        ...
        if (fieldType == 'BYTE') {
            ...
            if (this.components[fieldType].extensions !== undefined) {
                ...
                if (decoded.id !== undefined) {
					var extensions = this.components[fieldType].extensions;
					var extensionDef = false;
					for(var extensionId in extensions) {
						if(extensionId == decoded.id) extensionDef = extensions[extensionId];
					}
                    if (extensionDef != false) {
